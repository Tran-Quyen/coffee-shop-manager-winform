...
namespace Quan_Ly_Quan_Cafe.DAO
{
    public class BillInfoDAO
    {
       ...
       public void DeleteBillInfoByIDTable(int idTable)
        {
            int idBill = DataProvider.Instance.ExecuteNonQuery("Select id FROM dbo.Bill WHERE idTable = " + idTable);
            DataProvider.Instance.ExecuteQuery("Delete BillInfo WHERE idBill = " + idBill);
        }
    }
}
